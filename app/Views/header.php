...
<head>
    ...
    .rd-dropdown-menu {
        ...
        z-index: 1000;
        /* Ensure this is higher than the slider images' z-index */
    }
...
<body>
    ...
    <div class="preloader">
        <div class="preloader-logo"><a class="brand" href="index.html"><img class="brand-logo-dark"
                    src="public/assets/images/SkillForge.jpg" alt="" width="245" height="50" /><img
                    class="brand-logo-light" src="images/logo-inverse-245x50.png" alt="" width="245" height="50" /></a>
        </div>
                        ...
                        <div class="rd-navbar-main">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <div class="rd-navbar-brand"><a class="brand" href="index.html"><img
                                            class="brand-logo-dark" src="public/assets/images/SkillForge.jpg" alt=""
                                            width="245" height="50" /><img class="brand-logo-light"
                                            src="images/logo-inverse-245x50.png" alt="" width="245" height="50" /></a>
                                </div>
                            </div>
                            <div class="rd-navbar-nav-wrap">
                                ...
                                <ul class="rd-navbar-nav">
                                    ...
                                    <li class="rd-nav-item"><a class="rd-nav-link"
                                            href="<?php echo base_url('contact_us') ?>">Contacts</a>
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link"
