                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    ...
                                                    <i class="icofont icofont-image bg-c-blue card1-icon"></i>
                                                        <span class="text-c-blue f-w-600">Upload Images</span>
                                                        <h4>49/50GB</h4>
                                                        <div>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                    <i class="icofont icofont-video bg-c-green card1-icon"></i>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                    <i class="icofont icofont-file-document bg-c-yellow card1-icon"></i>
