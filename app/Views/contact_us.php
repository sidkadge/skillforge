...
<head>
    ...
    <!-- fevicon -->
    <link rel="icon" href="public/assets/images/fevicon.png" type="image/gif" />
...
<body class="main-layout">
    <!-- loader  -->
    <div class="loader_bg">
        <div class="loader"><img src="public/assets/images/loading.gif" alt="#" /></div>
    </div>
    <!-- end loader -->
    <!-- header -->
    <header>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="index.html"><img src="public/assets/images/murtikarlogo.jpg" alt="#" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="map_main">
                        <div class="map-responsive">
                            <iframe
                                ...
                                <!-- <img src="public/assets/images/contactus.jpeg" alt="Eiffel Tower" style="width: 100%; height: auto;"> -->
                        </div>
                    </div>
                </div>
            </div>
