                                        ...
                                        <div class="tab-content card-block">
                                            <div class="tab-pane active" id="home3" role="tabpanel">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="card">
                                                            <img src="<?= base_url('public/uploads/student/Images/' . esc($image['image_name'])) ?>"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="card video-container">
                                                            <video controls>
                                                                <source
                                                                    src="<?= base_url('public/uploads/student/Videos/' . esc($video['video_name'])) ?>"
                                                                    type="video/mp4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="card">
                                                            ...
                                                            <a href="<?php echo base_url('public/uploads/student/Doc/' . $doc['Doc_name']); ?>"
