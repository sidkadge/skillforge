                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                     src="<?= base_url('public/dashborads/images/profile.png') ?>" 
                                     style="max-width: 62%;height: auto;" alt="User profile picture">
                            </div>
                            <h5 class="profile-username text-center"><?= esc($faculty['username']) ?></h5>
                            <p class="text-muted text-center"><?= esc($faculty['email']) ?></p>
